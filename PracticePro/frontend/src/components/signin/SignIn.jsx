...
function SignIn() {
	...
	return (
		<div className="flex items-center justify-center p-16">
			<div className="w-[50%] max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 m-4">
...
// className="App h-[100vh] flex flex-col justify-center items-center"
